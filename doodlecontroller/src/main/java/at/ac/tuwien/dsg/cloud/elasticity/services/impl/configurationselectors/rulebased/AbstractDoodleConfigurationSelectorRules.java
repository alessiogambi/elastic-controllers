 ...
 * 
 */
public abstract class AbstractDoodleConfigurationSelectorRules implements
	...
	public ConfigurationSelectorDAO getConfigurationSelectorDAO() {
		return configurationSelectorDAO;
	}

	public void setConfigurationSelectorDAO(
	 ...
	 * @return
	 */
	abstract DynamicServiceDescription applyRules(
